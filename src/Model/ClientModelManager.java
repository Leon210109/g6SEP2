...
public class ClientModelManager implements RentalModel, PropertyChangeListener {
  ...
  // ViewModels are responsible for Platform.runLater() when updating JavaFX
  // state.
  ...
  public void propertyChange(PropertyChangeEvent evt) {
    ...
    switch (name) {
      ...
      case "LISTINGS_BY_OWNER": {
        Type t = new TypeToken<ArrayList<Listing>>() {
        }.getType();
      ...
      case "BOOKINGS_BY_CLIENT": {
        Type t = new TypeToken<ArrayList<Booking>>() {
        }.getType();
      ...
      case "BookingRemoved": {
        ...
        Type t = new TypeToken<ArrayList<Double>>() {
        }.getType();
      ...
      case "GET_ALL_OWNER_APPLICATIONS": {
        Type t = new TypeToken<ArrayList<OwnerApplication>>() {
        }.getType();
      ...
      case "TENANCY_APPS_BY_CLIENT": {
        Type t = new TypeToken<ArrayList<TenancyApplication>>() {
        }.getType();
